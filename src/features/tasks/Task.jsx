function Task({ task, handleStatus }) {
  return (
    <tr>
      ...
      <td className="px-4 py-2 border-b">
        <button
          className={`font-semibold text-xs sm:text-sm w-auto sm:w-40 h-12 sm:h-16 px-2 py-2 bg-sky-200 rounded-2xl whitespace-pre-wrap flex items-center justify-center ${
            task.completed
